...
function checkColumns(theGrid){
  ...
  /*       theGrid.children[0, 3, 6].removeAttribute("class", "neon-text-blue");
        theGrid.children[0, 3, 6].setAttribute("class", "neon-text-red"); */

        theGrid.querySelectorAll('g11, g21, g31').removeAttribute("class", "neon-text-blue");
        theGrid.querySelectorAll('g11, g21, g31').setAttribute("class", "neon-text-red");

       /*  theGrid.getElementsByName('g11, g21, g31').removeAttribute("class", "neon-text-blue"); */
